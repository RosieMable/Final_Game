...
namespace ZaldensGambit
{
    public class DialogueNPC : MonoBehaviour
    {
        ...
        private static bool isLoreTombInRange;
        private static DialogueNPC[] NPCs;
        private static LoreTomb[] LoreTombs;
        ...
        private void Start()
        {
            ...
            LoreTombs = FindObjectsOfType<LoreTomb>();
        }       
        ...
        protected virtual void Update()
        {
            ...
            bool loreTombInRange = false;
            foreach (LoreTomb tomb in LoreTombs)
            {
                if (tomb.inRange)
                {
                    loreTombInRange = true;
                    break;
                }
                else
                {
                    loreTombInRange = false;
                }
            }
            isLoreTombInRange = loreTombInRange;

            // If no NPCs dialogue is playing, remove dialogue box from UI
            if (!isDialoguePlaying && !isLoreTombInRange)
            {
