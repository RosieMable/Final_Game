...
public class UpdateShieldMesh : MonoBehaviour
{
    ...
    string[] colorProperties =
   {
    ...
    public void UpdateMeshEffect()
    {
        ...
        AddMaterialToMesh(MeshObject, VFXPrefab);
    }
    ...
    private void AddMaterialToMesh(GameObject go, GameObject _VFXPrefab)
    {
        var meshMatEffect = _VFXPrefab.GetComponentInChildren<ME_MeshMaterialEffect>();
